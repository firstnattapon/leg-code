...
5. ทดสอบ Connect & Load, Run 1–17 และ download ทั้ง Final/What-if
6. Production ใช้อ่านได้เท่านั้น; Preview, Submit และ Cancel ถูกปิดแบบ fail-closed

UAT actions อยู่หลัง Step 11 และแยกจากปุ่ม Run ทุกครั้ง: ต้อง Preview payload เดิม
ก่อน Submit พร้อมพิมพ์ confirmation phrase ให้ตรง Cancel ก็มี phrase แยก ผลที่เขียน
ลง `webull_lego_uat_audit` ถูก redact และไม่มี credentials/raw account response
